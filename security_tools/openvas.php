...
if(!empty($alertscanid))
{
	...
	logpp("logpp id_folder_bugs = ".$id_folder_bugs);
	logpp("logpp id_target = ".$id_target);
	logpp("logpp id_task = ".$id_task);
	logpp("logpp id_report = ".$id_report);
	logpp("logpp id_alert = ".$id_alert);
	logpp("logpp severity = ".$severity);
