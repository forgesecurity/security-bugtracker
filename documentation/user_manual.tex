...
\begin{itemize}
\item webissues : a bug tracker\\http://webissues.mimec.org/
\item openvas : a dynamic security vulnerabilities assessment tool\\http://www.openvas.org/
\item dependency-check : a static security vulnerabilities assessment tool\\https://github.com/jeremylong/DependencyCheck
\end{itemize}
\vspace{5mm}
...
\vspace{5mm}
\newline
Now create \textit{openvas} and \textit{Dependency-check} users on webissues.
\chapter{Use}
