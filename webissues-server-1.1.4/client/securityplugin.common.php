...
class Common_SecurityPlugin
{
	...
	{
		return Common_SecurityPlugin::common_scan($req, $targets);
	}
    ...
    {
		$issueId = Common_SecurityPlugin::common_scan($req, $targets);
	...
	public static function common_scan($req, $targets)
	{
        $issueId = 0;
		$issueManager = new System_Api_IssueManager();
		$projectManager = new System_Api_ProjectManager();
